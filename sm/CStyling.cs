...
namespace sm
{
    internal class CStyling
    {
        ...
        internal static List<object> Get(Type[]? types = null, List<object>? styles = null)
        {
            ...
            {
                List<object> filteredStyles = styles.Where(style => types.Contains(style.GetType())).ToList();
